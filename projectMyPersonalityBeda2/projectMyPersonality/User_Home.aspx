<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User_Home.aspx.cs" Inherits="User_Home" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
       <div class="topnav" id="myTopnav"> 
            ...
            <%--<a href="User_Home.aspx" class="btn btn-info">HOME</a>--%>
    ...
    <div id="ESTJModal" class="modal fade" >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="Result.aspx"><button id="button" class="btn btn-default">see the details<i class="fa fa-paper-plane-o ml-1"></i></button></a>
                </div>
            </div>
        </div>
    </div>
