<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminHome.aspx.cs" Inherits="adminHome" EnableEventValidation = "false"%>
...
<head runat="server">
  ...
  <title>MyPersonality - Admin Page</title>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <asp:Button class="btn btn-danger" ID="btnLogout" runat="server" Text="Logout" OnClick="btnLogout_Click" UseSubmitBehavior="false"/>
            </div>
          </div>
        </div>
      </div>
