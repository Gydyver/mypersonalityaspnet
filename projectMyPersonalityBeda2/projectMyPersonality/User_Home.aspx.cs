...
public partial class User_Home : System.Web.UI.Page
{
    ...
    public string question, id_question, userlast, category, answerfromdb, HasilAkhir, username;
    public string date;
    ...
    protected void btSubmit_Click(object sender, EventArgs e)
    {
        ...
        foreach (string key in Request.Form.AllKeys)
        {
            if (key.StartsWith("answer[") && key.EndsWith("]"))
            {
                ...
                int result2 = 0;
                string insert = "insert into answer_table (id_user,id_question,answer,answer_date) values (@iduser , @idquestion,@answer,@date)";
                SqlCommand com = new SqlCommand(insert, con);
                com.Parameters.AddWithValue("@iduser", userlast);
