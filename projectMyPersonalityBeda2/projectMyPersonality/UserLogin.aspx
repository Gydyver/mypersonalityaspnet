    ...
    <div id="page1">
        ...
        <div class="column fptext">
		    ...
		    <div class="fptext2">
                ...
                <a href="" class="btn btn-info fpbtn" title="take the test!" data-toggle="modal" data-target="#add_data_modal" id="btnTkThTest">Take The Test</a>
            ...
            <div class="fpicon" >
                ...
                <br />
                <asp:Label ID="lbltestemail" runat="server"></asp:Label>
		    </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <input type="email" name="test[0].email" id="email" title="ex email : emailname@hostname.com" class="form-control validate" style="margin: 3%; width: 500px;" pattern="[a-z0-9._%+-]+@[a-z0-9._]+\.[a-z]{2, 3}$"/>
